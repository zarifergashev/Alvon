...
public class BrusgNewFragment extends EIBaseFragment {
    ...
    public static Fragment newInstance(Bitmap image, IPhotoSaveHelper saveHelper) {
        BrusgNewFragment fragment = new BrusgNewFragment();
    ...
    private void drawOnTouchMove() {
        ...
        paint.setColor(Color.argb(125, 103, 58, 183));
