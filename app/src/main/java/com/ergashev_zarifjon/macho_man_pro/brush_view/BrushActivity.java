package com.ergashev_zarifjon.macho_man_pro.brush_view;
...
import com.ergashev_zarifjon.macho_man_pro.ui.activity.BaseActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            if (imageres != -1) {
                ...
                if (imagePath != null) {
                    readTempImage(imagePath,true, bitmap -> {
